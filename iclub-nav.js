/* ICLUB — franja negra de navegación compartida (categorías y detalle) */
(function () {
  ...
  bar.innerHTML = ''
    ...
    +   '<a href="Inicio ICLUB.dc.html" style="display:inline-flex;align-items:center;gap:10px;text-decoration:none;flex-shrink:0;">'
    ...
    +         '<a href="Android ICLUB.dc.html#and-sec-samsung">Samsung</a>'
    +         '<a href="Android ICLUB.dc.html#and-sec-xiaomi">Xiaomi</a>'
    +         '<a href="Android ICLUB.dc.html#and-sec-poco">Poco</a>'
    +         '<a href="Android ICLUB.dc.html#and-sec-motorola">Motorola</a>'
    +         '<a href="Android ICLUB.dc.html#and-sec-infinix">Infinix</a>'
    +         '<a class="zt-dd-all" href="Android ICLUB.dc.html">Ver todos los Android</a>'
    +       '</div></div></div>'
    +     '<div class="zt-nav-item"><a href="Smart TV ICLUB.dc.html" data-zt-page="tv">Smart TV ' + caret + '</a>'
